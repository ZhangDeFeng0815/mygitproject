...
public class AssetRightTInfo extends AssetInfo implements Serializable {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3168126295289207487L;
	private Long assetRightTId = null;
	// 资产ID
	...
	public Long getAssetRightTId() {
		return assetRightTId;
	}

	public void setAssetRightTId(Long assetRightTId) {
		this.assetRightTId = assetRightTId;
	}
